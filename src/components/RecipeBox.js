            ...
            <Card.Body
                ...
                <div
                    ...
                    <Button 
                        ...
                        Gefällt mir!  <t class="metric-text">  { metricsArray[1]&&(metricsArray[1].value + 1)}</t>
                    </Button>
                    )}
                    {!clickedLike&&(
                    <Button
                        ...
                        Gefällt mir  <t class="metric-text">  { metricsArray[1]&&(metricsArray[1].value)}</t>
                    </Button>
                    )}
                    {clickedCooked&&(
                    <Button
                        ...
                        Gekocht!  <t class="metric-text">  { metricsArray[0]&&(metricsArray[0].value + 1)}</t>
                    </Button>
                    )}
                    {!clickedCooked&&(
                    <Button
                        ...
                        Gekocht  <t class="metric-text">  { metricsArray[0]&&(metricsArray[0].value)}</t>
                    </Button>
                    )}
                </div>
                <div
