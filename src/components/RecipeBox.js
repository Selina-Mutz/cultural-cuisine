 ...
 */
export default function RecipeBox({ children, titleText, servings, timeText, difficultyText, cultureText, ingredientsArray, preparationTextArray, tipsTextArray, setFeatureFocus, images, flagImages, metricsArray }) {
            ...
            <Card.Body
                ...
                <div
                    ...
                    <Button 
                        ...
                        Gefällt mir!  <div className="number-div">{ metricsArray[1]&&(metricsArray[1].value + 1)}</div>
                    </Button>
                    )}
                    {!clickedLike&&(
                    <Button
                        ...
                        Gefällt mir  <div className="number-div">{ metricsArray[1]&&(metricsArray[1].value)}</div>
                    </Button>
                    )}
                    {clickedCooked&&(
                    <Button
                        ...
                        Gekocht!  <div className="number-div">{ metricsArray[0]&&(metricsArray[0].value + 1)}</div>
                    </Button>
                    )}
                    {!clickedCooked&&(
                    <Button
                        ...
                        Gekocht  <div className="number-div">{ metricsArray[0]&&(metricsArray[0].value)}</div>
                    </Button>
                    )}
                </div>
                <div
